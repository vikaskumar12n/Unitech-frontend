...
const Feedback = () => {
 ...
 return (
  <div className="relative flex items-center justify-center w-full py-12 bg-white">
   ...
   <div className="relative justify-center w-full max-w-7xl overflow-hidden">
    <div
   ...
   <button
    onClick={nextSlide}
    className="absolute right-4 p-3 text-black rounded-full shadow-lg  focus:outline-none z-20"
   >
    &gt;
   </button>
  </div>
