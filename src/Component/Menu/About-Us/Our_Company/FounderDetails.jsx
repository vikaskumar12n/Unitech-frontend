  ...
  return (
    <div className="bg-white p-8">
      <div className="container mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="text-gray-700 leading-relaxed text-base text-justify" data-aos="fade-right">
        ...
        <div className="flex-none w-full lg:w-1/4 flex flex-col items-center space-y-4" data-aos="fade-left">
          <img
