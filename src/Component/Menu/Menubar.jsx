...
const MenuBar = () => {
  ...
  const menuItems = [
    ...
    {
      name: "CUSTOMER SERVICE", dropdown: [
        { name: "Service Solution", link: "#" },
        { name: "Certifications ", link: " #" },
        { name: "warranty Registeration", link: "#" },
    ...
    {
      name: "PRESS AND INVESTORS", dropdown: [
      ...
      {item.dropdown && openDropdown === index && (
        ...
        <div className="md:hidden">
          <button
            ...
            className={`${mobileMenuOpen ? "text-white" : "text-black"} text-2xl`}
          >
