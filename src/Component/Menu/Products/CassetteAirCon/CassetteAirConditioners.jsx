...
const products = [
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-16 z-10">
    <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 drop-shadow-lg">
     Cassette<span className="text-blue-500">Air</span>Conditioner
    </h1>
    <p className="text-xl md:text-2xl text-gray-200 mb-8">
      Energy-efficient cassette ACs designed for comfort and elegance
    </p>
  </div>
  ...
  />
          ...
          <div className=" mt-16 px-4 py-6 relative z-10">
